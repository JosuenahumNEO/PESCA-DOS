...
ALTO_VENTANA = 600
<<<<<<< HEAD
COLOR_TEXTO_NORMAL = (255, 255, 255)  # Color de texto predeterminado
COLOR_TEXTO_HOVER = (255, 223, 129)  # Color del texto en hover
...
>>>>>>> 2cdf67de6b1c593535456b1379ac5791a8fa5ee1
    ...
    def dibujar_menu():
        ...
        # Dibujar título
<<<<<<< HEAD
        titulo_texto = FUENTE_TEXTO.render("Elegir nivel", True, (252,186,3))  # Cambiar el color del texto del título
        ventana.blit(titulo_texto, (ANCHO_VENTANA // 2 - titulo_texto.get_width() // 2, 60))
        
        
        titulo_texto = FUENTE_TEXTO.render("(Principiante)", True, (252,186,3))  # Cambiar el color del texto del título
        ventana.blit(titulo_texto, (ANCHO_VENTANA // 2 - titulo_texto.get_width() // 2, 140))
=======
...
<<<<<<< HEAD
            y_opcion = 200 + i *90  # Ajustar la separación vertical entre opciones
=======
...
<<<<<<< HEAD
                    ...
                    if seleccion == 0:  # Nivel 1
                        ...
                        pygame.quit()  # Cerrar la ventana actual
                        ejecutar_script('assets/niveles/principiante/nivel2/nivel2.py')  # Ejecutar el script de Nivel 2
                        
                        sys.exit()  # Salir del programa
                    elif seleccion == 2:  # Nivel 3
                        print("Seleccionando Nivel 3...")
                        pygame.quit()  # Cerrar la ventana actual
                        ejecutar_script('assets/niveles/principiante/nivel3/nivel3.py')  # Ejecutar el script de Nivel 3
...
>>>>>>> 2cdf67de6b1c593535456b1379ac5791a8fa5ee1
                        ...
                        pygame.quit()
<<<<<<< HEAD
                        ejecutar_script('assets/menu/jugar.py')  # Ejecutar el script del menú principal
=======
...
<<<<<<< HEAD
                        ...
                        print("Seleccionando Nivel 3...")
                        pygame.quit()
                        ejecutar_script('assets/niveles/principiante/nivel3/nivel3.py')
