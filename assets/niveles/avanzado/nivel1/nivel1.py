...
<<<<<<< HEAD
imagenes_basura = [Personaje.escalar_img(img, 80, 70) for img in imagenes_basura]
...
alturas_flotantes = [180 + i * 60 for i in range(17)]
...
<<<<<<< HEAD
anzulos_disponibles = 19  # Contador de anzuelos

reloj = pygame.time.Clock()
tiempo = 40  # Tiempo inicial del reloj
...
<<<<<<< HEAD
    ventana.blit(constantes.IMG_BACKGROUND_AVANZADO, (0, 0))  
...
<<<<<<< HEAD
    ...
    texto_puntos = fuente.render(f': {contador_puntos} / 17', True, (255, 0, 0))
